...
def student_home(request):
    try:
        ...
        # Total subjects in student's courses
        total_subjects = Subjects.objects.filter(course_id__in=courses).count()
        ...
        # Get subjects for the student's courses
        subject_data = Subjects.objects.filter(course_id__in=courses)
        ...
        messages.error(request, "دانشجو یافت نشد.")
...
def student_view_attendance(request):
    try:
        ...
        # Get subjects in these courses
        subjects = Subjects.objects.filter(course_id__in=courses)
