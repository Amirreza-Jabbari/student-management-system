...
urlpatterns = [
    ...
    path('import_excel/', HodViews.import_excel, name="import_excel"),
    ...
    path('some_error_page/', HodViews.some_error_page, name='some_error_page'),


    # Staff Attendance URLs
    path('staff_attendance_home/', HodViews.staff_attendance_home, name="staff_attendance_home"),
    path('take_staff_attendance/', HodViews.take_staff_attendance, name="take_staff_attendance"),
    path('save_staff_attendance/', HodViews.save_staff_attendance, name="save_staff_attendance"),
    path('staff_attendance_view/', HodViews.staff_attendance_view, name="staff_attendance_view"),
    path('staff_attendance_filter/', HodViews.staff_attendance_filter, name="staff_attendance_filter"),
]